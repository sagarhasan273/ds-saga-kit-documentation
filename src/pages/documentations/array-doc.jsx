    ...
    <DocContainer>
      ...
      <Section title="Overview">
        <p>
          ...
          class is a custom implementation of an array-like data structure in JavaScript. It
          provides similar functionality to native JavaScript arrays but stores data in an object
          with numeric keys.
        </p>
      </Section>
